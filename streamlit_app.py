...
# ==========================================
# MAIN CONTENT & HEADER (ไม่มี Sidebar และ Tabs)
# ==========================================
...
# ปุ่มประมวลผลขึงกว้างเต็มหน้าจอ
st.markdown("##")
...
if st.session_state.calculated and st.session_state.df_result is not None:
    ...
    # 2. Charts & Tables คู่ขนานเต็มหน้าจอ
    ...
    st.info("💡 **คำแนะนำ:** ปรับแต่งเงื่อนไขที่ต้องการใน **[แผงควบคุมด้านบน]** จากนั้นกดปุ่มคำนวณ ระบบจะแสดงรายงานผลลัพธ์และตัวเลขทางการเงินให้ทันที")
