...
# ==========================================
# 2. CUSTOM CSS FOR BACKGROUND & UI (WITH IMAGE FALLBACK)
# ==========================================
def add_background():
    """ฟังก์ชัน CSS ตั้งค่าภาพพื้นหลังฟาร์มไก่ไข่ระบบปิด พร้อมรองรับการแสดงผลทุกเบราว์เซอร์"""
    st.markdown(
        """
        <style>
        ...
        /* 2. ภาพพื้นหลังแม่ไก่ไข่สีน้ำตาลในโรงเรือนสะอาด (ซ้อนภาพสำรองกันลิงก์เสีย) */
        .stApp::before {
            content: "";
            position: fixed;
            top: 0; left: 0; width: 100vw; height: 100vh;
            background-image: 
                url("https://images.pexels.com/photos/5956934/pexels-photo-5956934.jpeg?auto=compress&cs=tinysrgb&w=1920"), /* ลิงก์หลัก: โรงเรือนไก่ไข่ */
                url("https://pixabay.com/get/g79ffdfa357b98ec3be121da63309e46a788b776c1251cc61b36bb566ecb8d0ca70b201fcfb7921868f066b5c3ff0647a_1920.jpg"); /* ลิงก์สำรอง */
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            background-attachment: fixed;
            opacity: 0.15; /* ปรับให้โปร่งแสง 15% เพื่อให้ตัวหนังสือสีขาวอ่านง่ายเด่นชัด */
            z-index: -1;
        }
...
# ฟังก์ชันช่วย Reset ผลคำนวณหากสเปคจำลองฟาร์มเปลี่ยนไป
...
if st.session_state.calculated and st.session_state.df_result is not None:
    # คำนวณตรรกะเศรษฐศาสตร์ฟาร์มตามเวลาจริง (Real-time Economic Logic)
            ...
            if st.button("💾 บันทึกสูตรลงฐานข้อมูลฟาร์ม", use_container_width=True):
                if supabase is not None:
                    try:
                        ...
                        # supabase.table("saved_formulas").insert(save_data).execute()
