    ...
    with page_tabs[0]:
        ...
        with col_right:
            ...
            comparison_table = [
                ...
                {"รายการโภชนาให้สำคัญ": "กรดอะมิโนจำเป็น ไลซีน (% Lysine)", "ระดับสารอาหารที่ได้จริง": f"{act_nut['lysine']:.2f} %"},
                {"รายการโภชนาให้สำคัญ": "กรดอะมิโนจำเป็น เมทไธโอนีน (% Methionine)", "ระดับสารอาหารที่ได้จริง": f"{act_nut['methionine']:.2f} %"},
