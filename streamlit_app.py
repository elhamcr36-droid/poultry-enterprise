...
# 2. CUSTOM CSS FOR BACKGROUND & UI (FIXED NameError)

# ==========================================

def add_background():

    """ฟังก์ชัน CSS แก้ไขบั๊ก NameError และล้างเลเยอร์สีเพื่อให้ภาพพื้นหลังแสดงผลได้สมบูรณ์"""
    ...
    st.markdown(
        ...
        /* 2. ดึงภาพฟาร์มไก่ไข่สีน้ำตาลในโรงเรือน (ตรงตามรูปแบบที่คุณต้องการ) */
        ...
        .stApp::before {
            ...
            /* ปรับค่าความชัดของภาพพื้นหลัง (0.35 กำลังสวย เห็นตัวไก่และไข่ชัดเจน) */
...
with input_col2:
    ...
    num_chickens = st.number_input("จำนวนไก่ไข่ในเล้า (ตัว)", min_value=1, value=180, step=10)

    feed_per_bird_g = st.number_input("อัตราการกินอาหาร (กรัม/ตัว/วัน)", min_value=1.0, value=180.0, step=5.0)
