...
with page_tabs[0]:
    ...
    with col_br3:
        ...
        if st.is_new_session or 'base_req_protein' not in st.session_state:
...
with page_tabs[1]:
    ...
    with log_col1:
        ...
        # แสดงระบบคำนวณอาหารแนะนำตัวจาง เพื่อไก่อยู่ดีกินดีไม่ขาดสารอาหาร
        recommended_feed = float(bird_count * current_breed_data["default_feed"] / 1000.0)
