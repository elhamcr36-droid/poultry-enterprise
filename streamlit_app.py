...
# กำหนดค่าลิงก์และคีย์ที่ถูกต้องตรงจากเซิร์ฟเวอร์หลัก
...
# ==========================================
# 📋 5. หน้าจอหลักในการคำนวณและประมวลผล
# ==========================================
...
with page_tabs[2]:
    ...
    st.markdown("ข้อมูลโภชนาการวัตถุดิบที่ดึงแบบ Real-time มาจากคลาวด์ฐานข้อมูล SQL ของคุณ")
